% March 2023 - Experimenting with the 2023 version of the MATLAB Robotics
% System Toolbox
clc; clear; close all

% Goal here is to build a robot 
% 

body1 = rigidBody('body1');

jnt1 = rigidBodyJoint('jnt1','revolute'); % generates the same default as body1.Joint
jnt1.HomePosition = pi/4;

% Converts from a translation vector to a homogenous transformation
